...
describe('WishlistView - Item Image Display', () => {
  it('displays image when item has ogImageUrl', () => {
  ...
  it('does not display image container when item has no ogImageUrl', () => {
      ...
      items: [
        {
          ...
          addedAt: '2024-01-01T00:00:00Z',
          claimed: false,
          ogImageUrl: 'https://example.com/broken-image.jpg',
        },
      ],
    };
